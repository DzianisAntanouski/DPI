...
```
set destinations="[{name: 'ErpQueryEndpoint', url: 'https://my300098-api.s4hana.ondemand.com/', username: 'COMM_USER_BUSINESS_PARTNER_API', password: 'SapCloudSDK2018isgood$'"
